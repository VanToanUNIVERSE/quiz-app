...
const SetQuiz = ({ handleCurrentQuestion, currentQuestion, onChange, quizIndex, answers, collapseInput, deleteQuiz }) => {
    ...
    return (
        <fieldset className=' border-1 border-blue-400 p-5 relative  rounded shadow-md shadow-blue-300'>
            ...
            <div className={`pt-3 transition-all duration-300 overflow-hidden ${collapse ? ' max-h-0 opacity-0' : ' max-h-[1000px]'}`}>
