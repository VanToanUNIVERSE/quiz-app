...
const InputGroup = (props) => {
    return (
        <div className='flex flex-col w-full relative'>
                ...
                <div className=' text-red-400 absolute right-5 top-[50%] translate-y-[-50%] translate-x-[-100%]'>{props.error === 'no error' ? <img className=" opacity-70 w-6 h-6 mt-2 -translate-y-0.5" src="/check.png"></img> : props.error} </div>
        </div>
    );
};
